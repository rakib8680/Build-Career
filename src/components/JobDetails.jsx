...
const JobDetails = () => {
    ...
    if (myJob) {
        const { logo, company, position, location, salary, type, description, requirements, experience, phone, email, responsibilities } = myJob
        return (
            <div>
                <h1 className='text-center text-3xl pt-10 pb-24 font-bold bg-gradient-to-r from-[#f2f3fb] to-[#f7f4ff]'>Job Details</h1>
                <div className='container mx-auto md:flex md:my-36 my-14 justify-center items-center gap-10 md:w-[1400px] p-5 md:p-0'>
                    ...
                    <div className='md:w-[750px]'>
                        <div className='space-y-5 bg-gradient-to-r from-[#f2f3fb] to-[#f7f4ff] p-6 rounded-md mb-5'>
                            ...
                            <div className='pb-2 space-y-3'>
                                <h1 className='flex'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-violet-500">
                        ...
                        <div className='text-center'>
                            <Link className='my-btn-primary'>Apply Now</Link>
                        </div>
                    </div>
                </div>
            </div>
